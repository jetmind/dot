...
" Modified by: Igor Bondarenko <jetmind2@gmail.com>
"  - most of the text uses default color, but:
"  - grey out comments & delimeters (e.g. parens in clojure)
"  - highlight by color: strings, keywords, booleans
"
...
hi Character       guifg=#BCDBFF
hi String          guifg=#BCDBFF
hi Keyword         guifg=#F92672
hi Error           guifg=#960050 guibg=#1E0010
hi Number          guifg=fg
hi Conditional     guifg=fg
